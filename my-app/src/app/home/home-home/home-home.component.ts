...
export class HomeHomeComponent implements OnInit {
  ...
  summary = 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus sagittis urna dui, et ullamcorper sem laoreet eu. Sed varius tristique nulla, nec congue tellus fringilla porta. Suspendisse scelerisque tincidunt orci, in consectetur diam posuere id.';
